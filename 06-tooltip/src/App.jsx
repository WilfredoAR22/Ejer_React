...
function App() {
  ...
  return (
    <div className="App">
      ...
      <p>Si longus, levis dictata sunt. De quibus cupio scire quid sentias. <TooltipText tooltip={"Hola a todos"}>Eam</TooltipText> tum adesse, cum dolor omnis absit; Et ille ridens: Video, inquit, quid agas; Respondent extrema primis, media utrisque, omnia omnibus. Sed mehercule pergrata mihi oratio tua. Ratio quidem vestra sic cogit. </p>
